...
resgene <- inner_join(resgene, jcgene_g, by="feature_id")
kresgene <- inner_join(kresgene, jcgene_g, by="feature_id")
...
restx <- inner_join(restx, jcgene_tx, by="feature_id")
krestx <- inner_join(krestx, jcgene_tx, by="feature_id")
